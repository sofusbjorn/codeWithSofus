...
// let (figTest2 : figure) = Mix(Mix((Circle((50, 50), 45, (fromRgb (255,0,0)))),(Circle((50, 100), 45, (fromRgb (255,0,0))))), Rectangle((40,40),(90,110),(fromRgb (0,0,255))))
...
let makePicture (fileName : string) (fig : figure) (b : int) (h : int) : unit =
    ...
    for i=0 to b-1 do
        for j=0 to h-1 do
            ...
            | None -> setPixel (fromRgb(128,128,128)) (i,j) (canvas) 
            | Some color -> setPixel (color) (i,j) (canvas)

    (toPngFile (fileName + ".png") (canvas))
