...
Koden køres ved først at compile .fs og .fsi filen: `fsharpc -a vec2dsmall.fsi vec2dsmall.fs`
Dernæst ved at køre black-box testen, *4i1.fsx*, sammen med library filen *vec2dsmall.dll*: `fsharpc -r vec2dsmall.dll 4i1.fsx && mono 4i1.exe`.
Desuden kan *4i2.fsx* også køres med samme procedure: `fsharpc -r vecdsmall.dll 4i2.fsx && mono 4i2.exe`
